...
## Mohammed Zuber contributed to this exercise.

## General Background Information
_Provide enough background on your topic that others can understand the why and how of your analysis_ 

## Description of data and data source
_The data set contains information regarding height, weight, and gender of 14 individuals. I have added the following two columns - Number of siblings, and Race. The number of siblings are reported as an integer number \>= 0. The Race variable has the following categories: White, Black, Hispanic, Asian, and Other. White and Black categories refer to Non-Hispanic White and Black individuals respectively. Hispanic category includes Hispanic and Latino individuals. Asian includes South and East Asian individuals. Those other than these are classified as Other. This variable s assumed to have self-reported information._
...
```
@fig-result2 shows the figure for Height vs Race
```{r}
#| label: fig-result2
#| fig-cap: "Height vs Race"
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","height and Race boxplot 2.png"))
```

@fig-result3 shows the figure for Number of Siblings vs Weight
```{r}
#| label: fig-result3
#| fig-cap: "Number of siblings vs Weight"
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","weight-siblings-scatterplot2.png"))
```
...
@tbl-resulttable3 shows a summary of linear model predicting height using number of siblings and race.
```{r}
